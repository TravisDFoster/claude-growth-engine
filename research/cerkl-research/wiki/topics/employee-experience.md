...
The full lived experience of working for the organization, of which internal communications is one input among many (manager relationship, workload, growth opportunity, recognition, physical/digital workplace, total rewards).

## Current Thesis

In 2025, employee wellbeing improved (Gallup "thriving" up to 34%, first uptick in three years) while engagement declined (down to 20%). This **wellbeing-engagement divergence** is the most interesting EX story of 2025: people feel slightly better about life overall while feeling less invested at work specifically. For IC strategy, this means communications that drive engagement (purpose, clarity, growth) and communications that drive wellbeing (recognition, belonging, transparency) are not interchangeable.
