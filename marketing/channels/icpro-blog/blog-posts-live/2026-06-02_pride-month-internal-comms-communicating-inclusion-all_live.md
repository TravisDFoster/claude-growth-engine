# Pride Month Internal Comms: Communicating Inclusion All Year, Not Just June
...
- Major structural changes: None. Argument order, paragraph balance, and section structure held from the draft. No section was thin or redundant; no list overuse to break up.
- Notable phrase/structure fixes: Removed the two em-dashes in the "Practical Year-Round Framework" paragraph (replaced with comma-bound apposition and a sentence break). Trimmed three "just" adverb uses where they were crutches (kept the title's "Not Just June," which is load-bearing). Cut one redundant clause that was the throat-clearing repeat of the section frame. Final body at 1097 words, in line with the channel's recent heritage-month and segmentation pieces (1098 and 1183 words). Reworded one hedged claim to land as an assertion ("says more about culture than any June statement").
- Brand-mention check: pass. Zero Cerkl mentions, zero competitor mentions. No vendor-category drift (no "modern intranet platforms" placeholder phrases needed for this topic).
