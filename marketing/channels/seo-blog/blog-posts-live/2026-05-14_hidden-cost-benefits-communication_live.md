...
In financial terms that leadership can hold, every dollar spent on a benefit that nobody understands is a dollar that bought nothing. The visible cost was already approved. The hidden cost is recoverable.

## Why it happens: from compliance to connection

Most internal-comms teams are not failing at benefits communication because they are unaware it could be better. They are failing because they are stuck on a maturity ladder that leadership rarely names.

The ladder has four rungs. **Compliance** is the bottom. Communication exists because regulation requires it. Boxes ticked, written by the cold hand of a lawyer. **Clarity** is one rung up. The team takes time to explain things in ways that help people understand what, when, and why it matters. **Relevance** is higher still. The team thinks about the message from the audience's perspective and personalizes content to reflect different lives, life stages, and known needs. **Connection** sits at the top. The team uses the comms moment to build trust and signal care. Transparency is the means; language is the proof.

Most organizations are stuck somewhere between clarity and relevance. The block is rarely a question of capability. It is a question of time and ownership. HR and total rewards teams hold the content but lack the bandwidth and the practice for coordinating year-round campaigns. Internal comms generalists hold the channels, but benefits sits behind quarterly results, leadership announcements, and culture initiatives in their queue. Both groups know what better would look like. Neither group has the room to build it.

The asymmetry becomes visible when you compare against marketing. No marketing team would launch a campaign without measuring whether the audience saw it, understood it, or acted on it. Yet people-related communication, which represents roughly 70 percent of most company budgets, gets a different standard. Tarek's question to Matt during their conversation framed the gap directly: *"How did we get to a state where something so important is reduced to checking a box?"*

The ladder is not asking for more output. It is asking for a different posture toward the audience: from informing them to fighting for their attention.

## The four moves to fight for attention

Matt drew the line cleanly: *"No one wakes up in the morning and thinks, 'I'm going to spend two and a half hours of my life cover to cover reading that benefits communication.'"* If the audience is not captive, every benefits message has to earn the open. Every other inbox, app, and notification is competing for the same thirty seconds. There are four moves that decide whether the message wins.

**Make it interesting.** A pensions campaign for a UK retailer built its messaging around a character named Nana, an agony-aunt grandma figure who was provocative, glamorous, and unapologetically herself. She replaced the white-linen-couple-on-a-beach financial-wellness cliché that nobody relates to. The point of the character was not novelty for its own sake. It was that the message stopped being skippable. An interesting opening earns a few seconds of attention, and a few seconds is the only window the audience is offering.

**Make it meaningful.** Connect the message to the moment the audience is in. *"If you are up at one in the morning searching the internet about your child's symptoms, we can help with that."* That sentence does work that *"we offer 24/7 telehealth as part of your benefits plan"* cannot do. Specificity about the moment beats a description of the benefit every time, because the audience finds the moment first and the benefit second.
...
**Make it findable.** Most companies' benefits content lives in a half-dozen places. An intranet page that is hard to find. PDFs in a shared drive. Vendor portals that require separate logins. Email archives that nobody searches. A single point of entry, organized for the user by life moment and by need, with search, filters, and tags, is the difference between a benefit that gets used in the moment and one that stays buried until somebody asks HR a direct question.
...
**Visibility** asks whether employees saw the message at all. **Accessibility** asks whether the underlying content was easy to reach when they wanted it. **Literacy** asks whether they understood what was offered. **Usage** asks whether they acted on it. **Experience** asks how the interaction felt, whether supported and respected or rushed and confused.

Each dimension can be measured through some combination of analytics, pulse surveys, focus groups, and anecdotal feedback. The goal is not a perfect dashboard. It is a benchmark you can return to, a way of saying, "this is what was true last year, and this is what is true now." Cerkl Broadcast's email analytics and audience-segment reporting cover the visibility, accessibility, and usage dimensions without manual data work, which gives a comms team a defensible baseline to start from.

The reason the framework matters is structural. Matt's line on it: *"If you can't measure it, you can't defend it. You can't ask for more budget. You can't dedicate resource to it. You can't bring in outside help."* Measurement is the budget-defense tool. It is what allows a comms team to walk into a budget conversation with leadership and connect the work to outcomes leadership already cares about.

*Matt Frost and Tarek Kamil walked through the diagnosis and the fixes in an hour-long conversation. [Watch the full session →](`<RECORDING_URL>`)*
...
That work is not a campaign. It is a posture. It looks like writing for the audience instead of the lawyer, building an evergreen hub before launching the next big push, replacing one annual cacophony with twelve months of small drum beats, and measuring the work in dimensions leadership recognizes as outcomes. None of it requires a bigger budget. Most of it requires a different system for sending email, one that supports segmentation, repeatable campaigns, and measurement as native features instead of side projects.
...
Open rates and click-throughs are starting points but are not sufficient. A more complete measurement structure asks five questions: did employees see the message (visibility), could they reach the underlying content (accessibility), did they understand what was offered (literacy), did they act on it (usage), and what was the felt quality of the interaction (experience). Each dimension can be captured through analytics, pulse surveys, focus groups, or anecdotal feedback. The goal is a benchmark you can return to over time, not a perfect dashboard.
...
- Major structural changes: Reframed Section 1 opener from "two recognizable forms" to "three places" so the structure matches the content. Cut redundant introductory clause in the four-moves opener. Tightened the conclusion's semicolon-heavy parallel construction.
- Notable phrase/structure fixes: Removed all 12 em-dashes (replaced with commas, periods, or sentence breaks). Cut banned adverbs ("just," "actually" x4 across body, H2, and FAQ). Replaced banned word "navigates/navigation" with "dig for it / does not ask them to." Cut binary contrast in the "make it meaningful" opener. Replaced colon-introduced inline list in "make it findable" with four short stand-alone sentences. Renamed Section 1 H2 from "What the hidden cost actually is" to "What the hidden cost looks like" to avoid the banned adverb in a heading.
- Verification: zero em-dashes, zero banned filler phrases, zero banned LLM tics in final body. SEO requirements: focus keyword "benefits communication" present in title, H1, three H3s (FAQ), and ~20 body mentions.
